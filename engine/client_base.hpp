...
namespace Engine
{
	...
	public:
		...
		virtual void on_socket_event(const fd_t& sock_fd, const NetEventType net_event, INetService* net_base);
		...
		NodeServerInfoPtr get_node_info(const INetService* net) {return m_node_client->get_node_info(net);}
