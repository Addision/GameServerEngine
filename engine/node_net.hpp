...
namespace Engine
{
	...
	public:
		...
		template<typename BaseType>
		void add_event_cb(BaseType* base_type, void(BaseType::*handle_event)(const fd_t& sock_fd, const NetEventType net_event, INetService* net_base))
		{
	...
	private:
		...
		void on_sock_event(const fd_t& sock_fd, const NetEventType net_event, INetService* net_base);
	protected:
