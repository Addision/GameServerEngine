...
////////////////////////////////////////////////////////////////////////////////////////
	...
	public:
		...
		template<typename BaseType>
		void add_event_cb(ServerType serv_type, BaseType* base_type, void(BaseType::*event_handler)(const fd_t& sock_fd, const NetEventType net_event, INetService* net_base))
		{
		...
		NodeServerInfoPtr get_node_info(const INetService* net);
